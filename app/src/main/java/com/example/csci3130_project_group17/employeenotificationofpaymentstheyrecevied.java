...
public class employeenotificationofpaymentstheyrecevied extends BaseAdapter {
    Context context;
    String fullname;
    String pay;
    String status_pays;
    ...
    public employeenotificationofpaymentstheyrecevied(Context applicationContext, String fullname, String pay, String status_pays, String date_pays) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = inflater.inflate(R.layout.paymentemployee2, null);
        employeename = convertView.findViewById(R.id.employername);
